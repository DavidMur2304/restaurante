        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-3">
                    ...
                    @else
                    <a href="{{ route('login') }}" class="text-xs bg-stone-800 text-white px-3 py-1.5 rounded-lg hover:bg-stone-700 transition-colors">Panel Camarero</a>
                    @endauth
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-stone-400">
                        ...
                        <li class="flex items-center gap-2">
                            ...
                            Mar–Jue: 13:00–22:00 · Vie–Sáb: 12:00–01:00 · Dom: 13:00–21:00
                        </li>
                        <li class="flex items-center gap-2">
